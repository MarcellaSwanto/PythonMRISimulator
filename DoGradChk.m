%This function isn't included in the python program as it is only used to
%generate an error message after checking Gz, Gy and gx
...
t = VSeq.tsLine(Flags~=0); %What is this notation
dt =  diff(t); %Need to look a bit
